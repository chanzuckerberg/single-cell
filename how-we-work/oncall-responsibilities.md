...
single-cell-curation (cellxgene-schema) | n/a | [manual release to test pypi](https://github.com/chanzuckerberg/single-cell-curation/blob/main/docs/release_process.md), if needed | manual release to prod pypi, if needed
